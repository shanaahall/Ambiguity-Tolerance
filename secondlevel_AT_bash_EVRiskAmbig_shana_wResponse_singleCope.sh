...
RunFile_01=${FSL_1stDATADIR}/${BIACID}_AT${RUN1}.feat/stats/${COPE}
RunFile_02=${FSL_1stDATADIR}/${BIACID}_AT${RUN2}.feat/stats/${COPE}
RunFile_03=${FSL_1stDATADIR}/${BIACID}_AT${RUN3}.feat/stats/${COPE}

mkdir -p ${OUTPUT}

cd ${TEMPLATE}
for i in 'secondlevel_AT_design_EVRiskAmbig_shana_wResponse_singleCope.fsf'; do
