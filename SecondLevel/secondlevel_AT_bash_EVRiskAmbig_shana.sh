...
FSL_1stDATADIR=$EXPERIMENT/Analysis/BIDS/AmbiguityTolerance/fmriprep_EVRiskAmbig_2020/Level1/sub-$BIACID
OUTPUT=$EXPERIMENT/Analysis/BIDS/AmbiguityTolerance/fmriprep_EVRiskAmbig_2020/Level2/sub-${BIACID}
...
cd ${TEMPLATE}
for i in 'secondlevel_AT_design_EVRiskAmbig_shana.fsf'; do
sed -e 's@OUTPUT@'$OUTPUT'@g'\
 -e 's@RunFile_01@'$RunFile_01'@g'\
 -e 's@RunFile_02@'$RunFile_02'@g'\
 -e 's@RunFile_03@'$RunFile_03'@g' <$i> ${OUTPUT}/${BIACID}.fsf
done
